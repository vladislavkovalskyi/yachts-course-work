...
function AdminBookingsPage() {
    ...
    const loadBookings = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["bookingsApi"].getAll({
                status: statusFilter !== "all" ? statusFilter : undefined,
                search: searchQuery || undefined
            });
            setBookings(data);
        } catch (err) {
            setError(err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"] ? err.message : "Failed to load bookings");
    ...
    const updateBookingStatus = async (id, status)=>{
        try {
            setUpdating(true);
            setError(null);
            const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["bookingsApi"].updateStatus(id, status);
            setBookings(bookings.map((b)=>b.id === id ? updated : b));
            if (selectedBooking?.id === id) {
                setSelectedBooking(updated);
            }
        } catch (err) {
            setError(err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"] ? err.message : "Failed to update booking status");
...
//# sourceMappingURL=_de9de488._.js.map